...
Comment.create(content: "Not great", book: Book.find_by(title: "Alexander Hamilton"), user: User.find_by(username: 'Bill'))
Comment.create(content: "on point", book: Book.find_by(title: "The New Right"), user: User.find_by(username: 'Bill'))
Comment.create(content: "meh", book: Book.find_by(title: "The New Right"), user: User.find_by(username: 'Sally'))
Comment.create(content: "Good read", book: Book.find_by(title: "KJV Bible"), user: User.find_by(username: 'Bill'))
Comment.create(content: "I prefer the ESV", book: Book.find_by(title: "KJV Bible"), user: User.find_by(username: 'Fred'))
Comment.create(content: "Good read", book: Book.find_by(title: "The Fountainhead"), user: User.find_by(username: 'Fred'))
Comment.create(content: "meh", book: Book.find_by(title: "The Fountainhead"), user: User.find_by(username: 'Sally'))
Comment.create(content: "Not great", book: Book.find_by(title: "The Fountainhead"), user: User.find_by(username: 'Linda'))
Comment.create(content: "Wow!", book: Book.find_by(title: "Modern Times"), user: User.find_by(username: 'Sally'))
